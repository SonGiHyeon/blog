...
const TokenomicsResearch = () => {
    const [showTokenomicsResearch, setshowTokenomicsResearch] = useState(false); // 1주차 정리본을 표시할지 말지에 대한 상태

    const toggleshowTokenomicsResearch = () => {
        setshowTokenomicsResearch(!showTokenomicsResearch); // 상태를 반전시켜서 보이거나 숨기게끔 설정
    };

    return (
        <div className="container">
            <button onClick={toggleshowTokenomicsResearch}>
                토크노믹스 리서치
            </button>

            {showTokenomicsResearch && (
                <section id="TokenomicsResearch">
...
export default TokenomicsResearch;
